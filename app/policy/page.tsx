        ...
        <main>
            <div className="container mx-auto px-5">
                <div className="mt-40 mb-20 bg-white">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">1. 個人情報の定義</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">2. 個人情報の収集方法</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">3. 収集する個人情報の種類</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">4. 個人情報の利用目的</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">5. 個人情報の第三者提供</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">6. 個人情報の安全管理</h2>
                    <p>当社は、個人情報の漏洩、滅失、き損を防止するため、適切なセキュリティ対策を実施し、個人情報の安全管理に努めます。個人情報を取り扱う従業員に対しては、個人情報保護の重要性を周知徹底するとともに、適切な教育を行います。</p>

                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">7. Cookieの使用について</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">8. お客様の権利</h2>
                    <p>お客様は、当社が保有するご自身の個人情報について、開示、訂正、追加、削除、利用停止または消去を請求することができます。請求を行う場合は、下記の連絡先までご連絡ください。ご本人確認のうえ、合理的な期間内に対応いたします。</p>

                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">9. プライバシーポリシーの変更</h2>
                    <p>当社は、必要に応じて本プライバシーポリシーを変更することがあります。変更後のプライバシーポリシーは、当ウェブサイト上に掲載された時点から効力を生じるものとします。重要な変更がある場合は、当ウェブサイト上で通知します。</p>

                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D]">10. お問い合わせ先</h2>

        ...
        <main>
            ...
            <div className="container mx-auto px-5">
                <div className="mt-32 mb-20 bg-gray-800 text-white rounded-lg p-10 shadow-sm">
                    <h1 className="text-4xl font-bold text-center text-white mb-8">利用規約</h1>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第1条（適用）</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第2条（利用登録）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第3条（ユーザーIDおよびパスワードの管理）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第4条（料金および支払方法）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第5条（禁止事項）</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第6条（本サービスの提供の停止等）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第7条（著作権）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第8条（利用制限および登録抹消）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第9条（退会）</h2>
                    <p className="mb-6">ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>

                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第10条（保証の否認および免責事項）</h2>
                    <ol className="list-decimal ml-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第11条（サービス内容の変更等）</h2>
                    <p className="mb-6">当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>

                    <h2 className="text-2xl font-bold mt-10 mb-5 pb-2 border-b-2 border-[#00A99D] text-white">第12条（利用規約の変更）</h2>
                    <ol className="list-decimal ml-6 mt-4">
